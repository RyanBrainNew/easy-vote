...
def editUserAgent():
    ...
    # HEIGHT = 640
    # PIXEL_RATIO = 3.0
    UA = 'Mozilla/5.0 (iPhone; CPU iPhone OS 8_0 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) ' \
         'Mobile/12A365 MicroMessenger/5.4.1 NetType/WIFI'
    ...
    driver.get(
        "http://jiayin.v.vote8.cn/m?OptionSearchTopicID=2890797&OptionSearchKeyword="
        "90&from=timeline&Topic_2890797_Page=3")
    ...
    time.sleep(2)
    # print('do pre')
    element = driver.find_element_by_css_selector('.Vote8ClickButton.Vote8ClickButtonNormal').click()
    time.sleep(1)
    # print('do verify')
